...
<div class="container-fluid mt-5">
    ...
    <form action="${pageContext.request.contextPath}/notice/update" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="boardTitle" value="${notice.boardTitle}" required>
        </div>
        <div class="mb-3">
            <label for="contents" class="form-label">내용</label>
            <textarea class="form-control" id="contents" name="boardContents" rows="5" required>${notice.boardContents}</textarea>
        </div>
        <div class="mb-3">
